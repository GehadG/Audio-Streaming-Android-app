...
import com.mimi.musicplayer.data.models.FeedResponse.FeedResponseItem
...
class FeedResponse : ArrayList<FeedResponseItem>() {
    ...
    data class FeedResponseItem(
        ...
        @SerializedName("artwork_url_retina") val artworkUrlRetina: String?,
        @SerializedName("background_url") val backgroundUrl: String?,
        @SerializedName("bpm") val bpm: String?,
        ...
        @SerializedName("release_timestamp") val releaseTimestamp: Int,
        @SerializedName("reshared") val reshared: Boolean,
        @SerializedName("reshares_count") val resharesCount: String?,
        @SerializedName("stream_url") val streamUrl: String?,
        @SerializedName("taged_artists") val tagedArtists: String?,
...
class UsernameDeserializer : JsonDeserializer<String?> {
    override fun deserialize(
        ...
        return json.asJsonObject["permalink"].asString
    }
}